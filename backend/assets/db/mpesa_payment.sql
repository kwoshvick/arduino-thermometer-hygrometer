...
CREATE TABLE IF NOT EXISTS `mpesa_payment` (
  ...
  `businessshortcode` varchar(20) NOT NULL,
  `billrefnumber` varchar(20) NOT NULL,
  `InvoiceNumber` varchar(20) NOT NULL,
  `OrgAccountBalance` varchar(20) NOT NULL,
  `ThirdPartyTransID` varchar(20) NOT NULL,
